...
BEGIN
	...
	-- ====================================================
	-- Load bronze.crm_cust_info into silver.crm_cust_info
	-- ====================================================
	...
	-- ==========================================================
	-- clean and load bronze.crm_prd_info into siver.crm_prd_info
	-- ==========================================================
...
-- ====================================================================
-- clean and load bronze.crm_sales_details into siver.crm_sales_details
-- ====================================================================
...
-- Inserting data into silver.crm_sales_details
	...
	-- ========================================================================
	-- Inserting bronze.erp_cust_az12 into  silver.erp_cust_az12 after cleaning
	-- ========================================================================
	set @start_time = getdate();
	...
	-- ==========================================================================
	-- inserting into silver.erp_loc_a101 from bronze.erp_loc_a101 after cleaning
	-- ==========================================================================
	set @start_time = getdate();
